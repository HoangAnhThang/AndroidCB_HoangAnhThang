...
public class AdapterStory2 extends ArrayAdapter<chitietTruyen> {
    Context context;
    int idlayout;
    ArrayList<chitietTruyen> storiesDetail;
    public AdapterStory2(@NonNull Context context, int resource, ArrayList<chitietTruyen> mylist) {
    ...
    @Nullable
    @Override
    public chitietTruyen getItem(int position) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        chitietTruyen storiesDetail = getItem(position);
